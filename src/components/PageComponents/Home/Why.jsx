...
function Why() {
  return (
    <div className="flex   relative  ">
      <div className="w-2/4 text-5xl text-green-900 font-bold left-11 relative ">
        Why you should <div>choose us</div>
        <div className="text-lg text-green-700 font-normal w-11/12 my-8 leading-7">
          Technological information and others, in addition to information about
          companies in the sector, list of any and all companies related toto
          agribusiness.
      ...
      <div className="w-2/4 ">
        <img
          src="https://cdn.pixabay.com/photo/2022/01/04/02/28/woman-6914029_1280.jpg"
